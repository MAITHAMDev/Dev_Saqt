...
local function check_member_super(cb_extra, success, result) 
  ...
  for k,v in pairs(result) do 
    ...
    if member_id ~= our_id then 
      ...
      save_data(_config.moderation.data, data) 
     local text = '✔️ تہٰم تہٰفہٰعہٰيہٰل آلہٰمہٰجموعہٰةة تہٰآج مہٰخہٰيے ✔️💋😻  : '..msg.to.title..'\n💋🕵 بہٰوآسہٰطہٰة مہٰطہٰوريے: @'..msg.from.username 
...
local kicked_num = "🤖 - آلآعہٰضہٰآء آلہٰمہٰطہٰروديہٰنہٰ : "..result.kicked_count.."\n" 
...
if result.username then 
   ...
   channel_username = "👾 - مہٰعہٰرفہ آلہٰمہٰجہٰمہٰوعہٰةة 🆔 :لآ يہٰوجہٰد 😂🍷" 
end 
...
local function lock_group_links(msg, data, target) 
  ...
  if group_link_lock == 'yes' then 
    return ' وآلہٰلہٰه 😒 آلہٰروآبہٰط مہٰقفہٰولہٰة ⛔️ لہٰتہٰضہٰوجنہٰي 🤖📌 \n‼️🤖 بہٰوآسہٰطة :    @'..msg.from.username..' \n🆔 آلآيہٰديے : '..msg.from.id..'\n'
  else 
...
local function unlock_group_links(msg, data, target) 
  ...
  if group_link_lock == 'no' then 
    return '📌 تہٰم فہٰتہٰح 😴 آلہٰروآبہٰط فہٰيے  آلہٰمہٰجموعٰةة 🤖\n‼️🤖 بہٰوآسہٰطة :    @'..msg.from.username..'\n🆔 آلآيہٰديے : '..msg.from.id..'\n'
  else 
...
local function lock_group_all(msg, data, target) 
  ...
  return '❗️☻   صہٰدقہٰنہٰيے ✝ تہٰم قہٰفہٰل 🔐⁉️ جہٰمہٰيہٰع آلہٰوسہٰآئہٰط \n‼️🤖 بہٰوآسہٰطة :    @'..msg.from.username..'\n🆔 آلآيہٰديے : '..msg.from.id
else 
    data[tostring(target)]['settings']['all'] = 'yes' 
    save_data(_config.moderation.data, data) 
return '❗️☻    تہٰم 👍 قہٰفہٰل 🔐⁉️ جہٰمہٰيہٰع آلہٰوسہٰآئہٰط \n‼️🤖 بہٰوآسہٰطة :    @'..msg.from.username..'\n🆔 آلآيہٰديے : '..msg.from.id  end 
end 
...
local function unlock_group_all(msg, data, target) 
  ...
  if group_all_lock == 'no' then 
    return '❗️☻   صہٰدقہٰنہٰيے ✝ تہٰم فہٰتہٰح 🔓⁉️ جہٰمہٰيہٰع آلہٰوسہٰآئہٰط \n‼️🤖 بہٰوآسہٰطة :    @'..msg.from.username..'\n🆔 آلآيہٰديے : '..msg.from.id  else 
    data[tostring(target)]['settings']['all'] = 'no' 
    save_data(_config.moderation.data, data) 
         return '❗️☻    تہٰم 👍 فہٰتہٰح 🔓⁉️ جہٰمہٰيہٰع آلہٰوسہٰآئہٰط \n‼️🤖 بہٰوآسہٰطة :    @'..msg.from.username..'\n🆔 آلآيہٰديے : '..msg.from.id  end 
end 
...
local function lock_group_leave(msg, data, target) 
  ...
  if group_leave_lock == 'yes' then 
    return ' صہٰدقہٰنہٰيے ✝ تہٰم قہٰفہٰل 🔐 آلہٰمہٰغہٰآدرة فيے آلہٰمہٰجموعہٰةة ↩️🙇🏻⁉️ \n‼️🤖  ہوآسہٰطہٰة :   @'..msg.from.username ..'\n🆔 آلآيہٰديے  : '..msg.from.id
  else 
    data[tostring(target)]['settings']['leave'] = 'yes' 
    save_data(_config.moderation.data, data) 
    return ' تہٰم 👍🏻 قہٰفہٰلہٰ 🔒 آلہٰمہٰغہٰآدرة فيے آلہٰمہٰجموعہٰةة 🙂⁉️ \n‼️🤖  ہوآسہٰطہٰة :   @'..msg.from.username ..'\n🆔 آلآيہٰديے  : '..msg.from.id
  end 
end 
...
local function unlock_group_leave(msg, data, target) 
  ...
  if group_leave_lock == 'no' then 
    return ' صہٰدقہٰنہٰيے ✝ تہٰم فہٰتہٰح 🔓 ⁉️ آلہٰمہٰغہٰآدرة  فيے آلہٰمہٰجموعہٰةة 😔🚶🏻 ❗️\n‼️🤖  ہوآسہٰطہٰة :   @'..msg.from.username ..'\n🆔 آلآيہٰديے  : '..msg.from.id
  else 
    data[tostring(target)]['settings']['leave'] = 'no' 
    save_data(_config.moderation.data, data) 
    return ' تہٰم 👍🏻فہٰتہٰح 🔓❗️ آلہٰمہٰغہٰآدرة  فيے آلہٰمہٰجموعہٰةة  😭🚶🏻\n‼️🤖  ہوآسہٰطہٰة :   @'..msg.from.username ..'\n🆔 آلآيہٰديے  : '..msg.from.id
  end 
end 
...
local function lock_group_reply(msg, data, target) 
  ...
  if group_reply_lock == 'yes' then 
    return ' صہٰدقہٰنہٰيے ✝ تہٰم قہٰفہٰل 🔐  آلہٰردود فيے آلہٰمہٰجموعہٰةة ↩️⁉️👾\n‼️🤖  ہوآسہٰطہٰة :   @'..msg.from.username ..'\n🆔 آلآيہٰديے  : '..msg.from.id
  else 
    data[tostring(target)]['settings']['reply'] = 'yes' 
    save_data(_config.moderation.data, data) 
    return ' تہٰم 👍🏻 قہٰفہٰلہٰ 🔒 آلہٰردود فيے آلہٰمہٰجموعہٰةة ↩️⁉️\n‼️🤖  ہوآسہٰطہٰة :   @'..msg.from.username ..'\n🆔 آلآيہٰديے  : '..msg.from.id
  end 
end 
...
local function unlock_group_reply(msg, data, target) 
  ...
  if group_reply_lock == 'no' then 
    return ' صہٰدقہٰنہٰيے ✝ تہٰم فہٰتہٰح 🔓 ⁉️ آلہٰردود فيے آلہٰمہٰجموعہٰةة 📋🤖 ❗️\n‼️🤖  ہوآسہٰطہٰة :   @'..msg.from.username ..'\n🆔 آلآيہٰديے  : '..msg.from.id
  else 
    data[tostring(target)]['settings']['reply'] = 'no' 
    save_data(_config.moderation.data, data) 
    return ' تہٰم 👍🏻فہٰتہٰح 🔓❗️ آلہٰردود  فيے آلہٰمہٰجموعہٰةة  📝🔓 \n‼️🤖  ہوآسہٰطہٰة :   @'..msg.from.username ..'\n🆔 آلآيہٰديے  : '..msg.from.id
  end 
end 
...
local function lock_group_username(msg, data, target) 
  ...
  if group_username_lock == 'yes' then 
    return ' صہٰدقہٰنہٰيے ✝ تہٰم قہٰفہٰل 🔐   آلہٰمہٰعہٰرفہٰ فيے آلہٰمہٰجموعہٰةة  @user 🆔⁉️👾 \n‼️🤖  ہوآسہٰطہٰة :   @'..msg.from.username ..'\n🆔 آلآيہٰديے  : '..msg.from.id
  else 
    data[tostring(target)]['settings']['username'] = 'yes' 
    save_data(_config.moderation.data, data) 
    return ' تہٰم 👍🏻 قہٰفہٰلہٰ 🔒 آلہٰمہٰعہٰرفہٰ فيے آلہٰمہٰجموعہٰةة  @user 🆔⁉️\n‼️🤖  ہوآسہٰطہٰة :   @'..msg.from.username ..'\n🆔 آلآيہٰديے  : '..msg.from.id
  end 
end 
...
local function unlock_group_username(msg, data, target) 
  ...
  if group_username_lock == 'no' then 
    return ' صہٰدقہٰنہٰيے ✝ تہٰم فہٰتہٰح 🔓 ⁉️ آلہٰمہٰعہٰرفہٰ فيے آلہٰمہٰجموعہٰةة  @user 🆔 ❗️\n‼️🤖  ہوآسہٰطہٰة :   @'..msg.from.username ..'\n🆔 آلآيہٰديے  : '..msg.from.id
  else 
    data[tostring(target)]['settings']['username'] = 'no' 
    save_data(_config.moderation.data, data) 
    return ' تہٰم 👍🏻فہٰتہٰح 🔓❗️ آلہٰمہٰعہٰرفہٰ فيے آلہٰمہٰجموعہٰةة  @user 🆔\n‼️🤖  ہوآسہٰطہٰة :   @'..msg.from.username ..'\n🆔 آلآيہٰديے  : '..msg.from.id
  end 
end 
...
local function lock_group_media(msg, data, target) 
  ...
  if group_media_lock == 'yes' then 
    return ' صہٰدقہٰنہٰيے ✝ تہٰم قہٰفہٰل 🔐   آلہٰمہٰيہٰديہٰآ فيے آلہٰمہٰجموعہٰةة  🗂⁉️👾\n‼️🤖  ہوآسہٰطہٰة :   @'..msg.from.username ..'\n🆔 آلآيہٰديے  : '..msg.from.id
  else 
    data[tostring(target)]['settings']['media'] = 'yes' 
    save_data(_config.moderation.data, data) 
    return ' تہٰم 👍🏻قہٰفہٰلہٰ🔒❗️ آلہٰمہٰيہٰديہٰآ فيے آلہٰمہٰجموعہٰةة  🗂⁉️👾 \n‼️🤖  ہوآسہٰطہٰة :   @'..msg.from.username ..'\n🆔 آلآيہٰديے  : '..msg.from.id
  end 
end 
...
local function unlock_group_media(msg, data, target) 
  ...
  if group_media_lock == 'no' then 
    return ' صہٰدقہٰنہٰيے ✝ تہٰم فہٰتہٰح 🔓 ⁉️  آلہٰمہٰيہٰديہٰآ فيے آلہٰمہٰجموعہٰةة  🗂 ❗️ \n‼️🤖  ہوآسہٰطہٰة :   @'..msg.from.username ..'\n🆔 آلآيہٰديے  : '..msg.from.id
  else 
    data[tostring(target)]['settings']['media'] = 'no' 
    save_data(_config.moderation.data, data) 
    return ' تہٰم 👍🏻فہٰتہٰح 🔓❗️ آلہٰمہٰيہٰديہٰآ فيے آلہٰمہٰجموعہٰةة  🗂⚠️ \n‼️🤖  ہوآسہٰطہٰة :   @'..msg.from.username ..'\n🆔 آلآيہٰديے  : '..msg.from.id
  end 
end 
...
local function lock_group_fosh(msg, data, target) 
  ...
  if group_fosh_lock == 'yes' then 
    return ' صہٰدقہٰنہٰيے ✝ تہٰم قہٰفہٰل 🔐  آلہٰكہٰلہٰمہٰآتہٰ آلہٰسہٰيہٰئہٰةة 🙂💔 \n‼️🤖  ہوآسہٰطہٰة :   @'..msg.from.username ..'\n🆔 آلآيہٰديے  : '..msg.from.id
  else 
    data[tostring(target)]['settings']['fosh'] = 'yes' 
    save_data(_config.moderation.data, data) 
    return ' تہٰم 👍🏻قہٰفہٰلہٰ🔒 آلہٰكہٰلہٰمہٰآتہٰ آلہٰسہٰيہٰئہٰةة  ⁉️🤖 \n‼️🤖  ہوآسہٰطہٰة :   @'..msg.from.username ..'\n🆔 آلآيہٰديے  : '..msg.from.id
  end 
end 
...
local function unlock_group_fosh(msg, data, target) 
  ...
  if group_fosh_lock == 'no' then 
    return ' تصہٰدقہٰنہٰيے ✝ تہٰم فہٰتہٰح 🔓 ⁉️  آلہٰكہٰلہٰمہٰآتہٰ آلہٰسہٰيہٰئہٰةة ❗️😡🤖 \n‼️🤖  ہوآسہٰطہٰة :   @'..msg.from.username ..'\n🆔 آلآيہٰديے  : '..msg.from.id
  else 
    data[tostring(target)]['settings']['fosh'] = 'no' 
    save_data(_config.moderation.data, data) 
    return ' تہٰم 👍🏻فہٰتہٰح 🔓❗️ آلہٰكہٰلہٰمہٰآتہٰ آلہٰسہٰيہٰئہٰةة  😕🤖 \n‼️🤖  ہوآسہٰطہٰة :   @'..msg.from.username ..'\n🆔 آلآيہٰديے  : '..msg.from.id
  end 
end 
...
local function lock_group_join(msg, data, target) 
  ...
  if group_join_lock == 'yes' then 
    return ' صہٰدقہٰنہٰيے ✝ تہٰم قہٰفہٰل 🔐  آلہٰدخہٰولہٰ عہٰبہٰر آلہٰرآبہٰط 😴💤 \n‼️🤖  ہوآسہٰطہٰة :   @'..msg.from.username ..'\n🆔 آلآيہٰديے  : '..msg.from.id
  else 
    data[tostring(target)]['settings']['join'] = 'yes' 
    save_data(_config.moderation.data, data) 
    return ' تہٰم 👍🏻قہٰفہٰلہٰ🔒 آلہٰدخہٰولہٰ عہٰبہٰر آلہٰرآبہٰط⁉️👾 \n‼️🤖  ہوآسہٰطہٰة :   @'..msg.from.username ..'\n🆔 آلآيہٰديے  : '..msg.from.id
  end 
end 
...
local function unlock_group_join(msg, data, target) 
  ...
  if group_join_lock == 'no' then 
    return ' صہٰدقہٰنہٰيے ✝ تہٰم فہٰتہٰح 🔓 ⁉️  آلہٰدخہٰولہٰ عہٰبہٰر آلہٰرآبہٰط 🙇🏻🍷 \n‼️🤖  ہوآسہٰطہٰة :   @'..msg.from.username ..'\n🆔 آلآيہٰديے  : '..msg.from.id
  else 
    data[tostring(target)]['settings']['join'] = 'no' 
    save_data(_config.moderation.data, data) 
    return ' تہٰم 👍🏻فہٰتہٰح 🔓❗️ آلہٰدخہٰولہٰ عہٰبہٰر آلہٰرآبہٰط 📝🤖 \n‼️🤖  ہوآسہٰطہٰة :   @'..msg.from.username ..'\n🆔 آلآيہٰديے  : '..msg.from.id
  end 
end 
...
local function lock_group_fwd(msg, data, target) 
  ...
  if group_fwd_lock == 'yes' then 
    return ' صہٰدقہٰنہٰيے ✝ تہٰم 👍🏻قہٰفہٰلہٰ🔐 آعہٰآدة آلہٰتہٰوجہٰيہٰه 🔁  فيے  آلہٰمہٰجموعہٰةة 🤖😡 \n‼️🤖  ہوآسہٰطہٰة :   @'..msg.from.username ..'\n🆔 آلآيہٰديے  : '..msg.from.id
  else 
    data[tostring(target)]['settings']['fwd'] = 'yes' 
    save_data(_config.moderation.data, data) 
    return ' تہٰم 👍🏻قہٰفہٰلہٰ🔐 آعہٰآدة آلہٰتہٰوجہٰيہٰه 🔁  فيے  آلہٰمہٰجموعہٰةة 🤖❗️ \n‼️🤖  ہوآسہٰطہٰة :   @'..msg.from.username ..'\n🆔 آلآيہٰديے  : '..msg.from.id
  end 
end 
...
local function unlock_group_fwd(msg, data, target) 
  ...
  if group_fwd_lock == 'no' then 
    return ' صہٰدقہٰنہٰيے ✝ تہٰم 👍🏻 فہٰتہٰح 🔓 ⁉️ آعہٰآدة آلہٰتہٰوجہٰيہٰه 🔁  فيے  آلہٰمہٰجموعہٰةة 😡📋 \n‼️🤖  ہوآسہٰطہٰة :   @'..msg.from.username ..'\n🆔 آلآيہٰديے  : '..msg.from.id
  else 
    data[tostring(target)]['settings']['fwd'] = 'no' 
    save_data(_config.moderation.data, data) 
    return ' تہٰم 👍🏻فہٰتہٰح 🔓❗️ آعہٰآدة آلہٰتہٰوجہٰيہٰه 🔁  فيے  آلہٰمہٰجموعہٰةة 🙄🤖 \n‼️🤖  ہوآسہٰطہٰة :   @'..msg.from.username ..'\n🆔 آلآيہٰديے  : '..msg.from.id
  end 
end 
...
local function lock_group_english(msg, data, target) 
  ...
  if group_english_lock == 'yes' then 
    return ' صہٰدقہٰنہٰيے ✝ تہٰم قہٰفہٰلہٰ🔒 آللہٰغہٰةة آلآنہٰكہٰلہٰيہٰزيہٰةة📝❌ \n‼️🤖  ہوآسہٰطہٰة :   @'..msg.from.username ..'\n🆔 آلآيہٰديے  : '..msg.from.id
  else 
    data[tostring(target)]['settings']['english'] = 'yes' 
    save_data(_config.moderation.data, data) 
    return ' تہٰم 👍🏻 قہٰفہٰلہٰ 🔒 آللہٰغہٰةة آلآنہٰكہٰلہٰيہٰزيہٰةة📝 🔐 \n‼️🤖  ہوآسہٰطہٰة :   @'..msg.from.username ..'\n🆔 آلآيہٰديے  : '..msg.from.id
  end 
end 
...
local function unlock_group_english(msg, data, target) 
  ...
  if group_english_lock == 'no' then 
    return ' صہٰدقہٰنہٰيے ✝ تہٰم فہٰتہٰح 🔓⁉️ آللہٰغہٰةة آلآنہٰكہٰلہٰيہٰزيہٰةة📝👥👏🏻  \n‼️🤖  ہوآسہٰطہٰة :   @'..msg.from.username ..'\n🆔 آلآيہٰديے  : '..msg.from.id
  else 
    data[tostring(target)]['settings']['english'] = 'no' 
    save_data(_config.moderation.data, data) 
    return ' تہٰم 👍🏻 فہٰتہٰح 🔓آللہٰغہٰةة آلآنہٰكہٰلہٰيہٰزيہٰةة📝 ✅ \n‼️🤖  ہوآسہٰطہٰة :   @'..msg.from.username ..'\n🆔 آلآيہٰديے  : '..msg.from.id
  end 
end 
...
local function lock_group_emoji(msg, data, target) 
  ...
  if group_emoji_lock == 'yes' then 
    return ' صہٰدقہٰنہٰيے ✝ تہٰم قہٰفہٰل 🔐 آلہٰسہٰمآيہٰلآتہٰ 🙂🤖 \n‼️🤖  ہوآسہٰطہٰة :   @'..msg.from.username ..'\n🆔 آلآيہٰديے  : '..msg.from.id
  else 
    data[tostring(target)]['settings']['emoji'] = 'yes' 
    save_data(_config.moderation.data, data) 
    return 'تہٰم 👍🏻قہٰفہٰلہٰ🔒آلہٰسہٰمآيہٰلآتہٰ 🙂🤖 \n‼️🤖  ہوآسہٰطہٰة :   @'..msg.from.username ..'\n🆔 آلآيہٰديے  : '..msg.from.id
  end 
end 
...
local function unlock_group_emoji(msg, data, target) 
  ...
  if group_emoji_lock == 'no' then 
    return 'صہٰدقہٰنہٰيے ✝ تہٰم فہٰتہٰح 🔓   آلہٰسہٰمآيہٰلآتہٰ 😡😂🤖 \n‼️🤖  ہوآسہٰطہٰة :   @'..msg.from.username ..'\n🆔 آلآيہٰديے  : '..msg.from.id
  else 
    data[tostring(target)]['settings']['emoji'] = 'no' 
    save_data(_config.moderation.data, data) 
    return 'تہٰم 👍🏻فہٰتہٰح 🔓 آلہٰسہٰمآيہٰلآتہٰ 😡😂🤖 \n‼️🤖  ہوآسہٰطہٰة :   @'..msg.from.username ..'\n🆔 آلآيہٰديے  : '..msg.from.id
  end 
end 
...
local function lock_group_tag(msg, data, target) 
  ...
  if group_tag_lock == 'yes' then 
    return 'صہٰدقہٰنہٰيے ✝ تہٰم قہٰفہٰل 🔐 آلہٰتہٰآكہٰ فيے  آلہٰمہٰجموعہٰةة   📋🤖 \n‼️🤖  ہوآسہٰطہٰة :   @'..msg.from.username ..'\n🆔 آلآيہٰديے  : '..msg.from.id
  else 
    data[tostring(target)]['settings']['tag'] = 'yes' 
    save_data(_config.moderation.data, data) 
    return 'تہٰم 👍🏻قہٰفہٰلہٰ🔒 آلہٰتہٰآكہٰ فيے  آلہٰمہٰجموعہٰةة   📋🤖 \n‼️🤖  ہوآسہٰطہٰة :   @'..msg.from.username ..'\n🆔 آلآيہٰديے  : '..msg.from.id
  end 
end 
...
local function unlock_group_tag(msg, data, target) 
  ...
  if group_tag_lock == 'no' then 
    return 'صہٰدقہٰنہٰيے ✝ تہٰم فہٰتہٰح 🔓 آلہٰتہٰآكہٰ فيے  آلہٰمہٰجموعہٰةة   🎻🤖 \n‼️🤖  ہوآسہٰطہٰة :   @'..msg.from.username ..'\n🆔 آلآيہٰديے  : '..msg.from.id
  else 
    data[tostring(target)]['settings']['tag'] = 'no' 
    save_data(_config.moderation.data, data) 
    return 'تہٰم 👍🏻فہٰتہٰح 🔓 آلہٰتہٰآكہٰ فيے  آلہٰمہٰجموعہٰةة   🎻🤖 \n‼️🤖  ہوآسہٰطہٰة :   @'..msg.from.username ..'\n🆔 آلآيہٰديے  : '..msg.from.id
  end 
end 
...
local function unlock_group_spam(msg, data, target) 
  ...
  if group_spam_lock == 'no' then 
    return 'وآلہٰلہٰه 😐  آلہٰتہكہٰرآر مہٰفہٰتہٰوح❓ لہٰتہٰضہٰوجنہٰي 🙁🍷 \n‼️🤖  ہوآسہٰطہٰة :   @'..msg.from.username ..'\n🆔 آلآيہٰديے  : '..msg.from.id
  else 
...
local function unlock_group_flood(msg, data, target) 
  ...
  if group_flood_lock == 'no' then 
    ...
    save_data(_config.moderation.data, data) 
    return ' ❌ تہٰم فہٰتہٰح آلہٰتہٰكہٰرآر  كہٰبہٰديے   ❌ ⛔️\n‼️🤖  ہوآسہٰطہٰة :   @'..msg.from.username ..'\n🆔 آلآيہٰديے  : '..msg.from.id
  end 
end 
...
local function lock_group_tgservice(msg, data, target) 
  ...
  if group_tgservice_lock == 'yes' then 
    return ' صہٰدقہٰنہٰيے ✝ تہٰم قہٰفہٰل 🔐  آشہٰعہٰآرآتہٰ آلہٰدخہٰولہٰ   📋🤖\n‼️🤖  ہوآسہٰطہٰة :   @'..msg.from.username ..'\n🆔 آلآيہٰديے  : '..msg.from.id 
  else 
    data[tostring(target)]['settings']['lock_tgservice'] = 'yes' 
    save_data(_config.moderation.data, data) 
    return ' تہٰم 👍🏻قہٰفہٰلہٰ🔒 آشہٰعہٰآرآتہٰ آلہٰدخہٰولہٰ  📋🤖\n‼️🤖  ہوآسہٰطہٰة :   @'..msg.from.username ..'\n🆔 آلآيہٰديے  : '..msg.from.id 
  end 
end 
...
local function unlock_group_tgservice(msg, data, target) 
  ...
  if group_tgservice_lock == 'no' then 
    return ' صہٰدقہٰنہٰيے ✝ تہٰم فہٰتہٰح 🔓  آشہٰعہٰآرآتہٰ آلہٰدخہٰولہٰ  🎻🤖\n‼️🤖  ہوآسہٰطہٰة :   @'..msg.from.username ..'\n🆔 آلآيہٰديے  : '..msg.from.id 
  else 
    data[tostring(target)]['settings']['lock_tgservice'] = 'no' 
    save_data(_config.moderation.data, data) 
    return ' تہٰم 👍🏻فہٰتہٰح 🔓 آشہٰعہٰآرآتہٰ آلہٰدخہٰولہٰ  🎻🤖 \n‼️🤖  ہوآسہٰطہٰة :   @'..msg.from.username ..'\n🆔 آلآيہٰديے  : '..msg.from.id 
  end 
end 
...
local function lock_group_bots(msg, data, target) 
  ...
  if group_bots_lock == 'yes' then 
    return 'صہٰدقہٰنہٰيے ✝ تہٰم قفل 🔐 آلہٰبہٰوتہٰآتہٰ ❗️  فيے  آلہٰمہٰجموعہٰةة  🎻🤖  \n‼️🤖  ہوآسہٰطہٰة :   @'..msg.from.username ..'\n🆔 آلآيہٰديے  : '..msg.from.id 
  else 
    data[tostring(target)]['settings']['lock_bots'] = 'yes' 
    save_data(_config.moderation.data, data) 
    return ' تہٰم 👍🏻 قفل 🔐 آلہٰبہٰوتہٰآتہٰ 👾  فيے  آلہٰمہٰجموعہٰةة  🎻🤖  \n‼️🤖  ہوآسہٰطہٰة :   @'..msg.from.username ..'\n🆔 آلآيہٰديے  : '..msg.from.id 
  end 
end 
...
local function unlock_group_bots(msg, data, target) 
  ...
  if group_bots_lock == 'no' then 
    return 'صہٰدقہٰنہٰيے ✝ تہٰم فہٰتہٰح 🔓  آلہٰبہٰوتہٰآتہٰ 👾  فيے  آلہٰمہٰجموعہٰةة 🕵🍸  \n‼️🤖  ہوآسہٰطہٰة :   @'..msg.from.username ..'\n🆔 آلآيہٰديے  : '..msg.from.id 
  else 
    data[tostring(target)]['settings']['lock_bots'] = 'no' 
    save_data(_config.moderation.data, data) 
    return ' تہٰم 👍🏻 فہٰتہٰح 🔓 آلہٰبہٰوتہٰآتہٰ 👾  فيے  آلہٰمہٰجموعہٰةة  🤖🍷  \n‼️🤖  ہوآسہٰطہٰة :   @'..msg.from.username ..'\n🆔 آلآيہٰديے  : '..msg.from.id 
  end 
end 
...
function show_supergroup_settingsmod(msg, target) 
  ...
  local text = "️SuperGroups Settings: ⇣ ⇣\n👥 آسہٰم آلہٰكہٰرؤبہٰ : "..msg.to.title.."\n〰➖〰➖〰➖〰➖〰\n🔗 آلہٰروآبہٰط : "..settings.lock_link.."\n🔐 آلہٰتہٰكہٰرآر: "..settings.flood.."\n👾 عہٰدد آلہٰتہٰكہٰرآر : "..NUM_MSG_MAX.."\n📊 آلہٰكلآيہٰش: "..settings.lock_spam.."\n👤 آلآضہٰآفہٰة: "..settings.lock_member.."\n🎡 آلہٰمہٰلہٰصہٰقہٰآتہٰ: "..settings.lock_sticker.."\n🤖 آلہٰبہٰوتہٰآتہٰ: "..bots_protection.."\n↩️ fwd(آلہٰتہٰوجہٰيہٰه): "..settings.fwd.."\n🏧 آلہٰكہٰلہٰمہٰآت آلہٰسہٰيہٰئہٰة: "..settings.fosh.."\n🚶آلمہٰغہٰآدرة: "..settings.leave.."\n🔕 آلہٰوسہٰآئط: "..settings.all.."\n〰➖〰➖〰➖〰➖〰\n️About Group: ↯️\n〰➖〰➖〰➖〰➖〰\nGroup type: "..gp_type.."\n✳️Public: "..settings.public.."\n⛔️Strict settings: "..settings.strict.."\n〰➖〰➖〰➖〰➖〰\n\n 🕵  قہٰنآة آلہٰمہٰطہٰور :- @Ch_Dev 🔊" 
  return text 
end 
...
local function demote_admin(receiver, member_username, user_id) 
  ...
  if not data[group]['moderators'][tostring(user_id)] then 
    return send_large_msg(receiver, member_tag_username..' هہٰذا آلہٰشہٰخہٰص لہٰيہٰس آدمہٰن 😢🤖 ') 
  end 
...
local function promote2(receiver, member_username, user_id) 
  ...
  data[group]['moderators'][tostring(user_id)] = member_tag_username 
  save_data(_config.moderation.data, data) 
  send_large_msg(receiver, member_username..' آركہٰص شہٰغہٰلہٰ مہٰعہٰزوفہٰةة رفہٰعہٰوكہٰ آدمہٰن 🙀😹🙌 .') 
end 
...
local function demote2(receiver, member_username, user_id) 
  ...
  if not data[group]['moderators'][tostring(user_id)] then 
  return send_large_msg(receiver, member_username..' هہٰذا آلہٰشہٰخہٰص لہٰيہٰس آدمہٰن 😢🤖')
  end 
  data[group]['moderators'][tostring(user_id)] = nil 
  save_data(_config.moderation.data, data) 
...
function get_message_callback(extra, success, result) 
   ...
   elseif get_cmd == "تنزيل المدير" then 
      local user_id = result.from.peer_id 
      local channel_id = "channel#id"..result.to.peer_id 
...
local function cb_user_info(extra, success, result) 
   ...
   if get_cmd == "تنزيل اداري" then 
      if is_admin2(result.peer_id) then 
         return send_large_msg(receiver, "لآ تہٰلہٰعہٰبہٰ آبہٰنيے 🚷 لآ يہٰمہٰكہٰنہٰك تہٰنہٰزيہٰلہٰ الآدمہٰنہٰيہٰةة 🤖🍷.") 
      end 
      local user_id = "user#id"..result.peer_id 
...
local function callbackres(extra, success, result) 
  ...
  elseif get_cmd == "invite" then 
   ...
   elseif get_cmd == "تنزيل اداري" then 
      ...
      local channel_id = extra.channel 
      if is_admin2(result.peer_id) then 
         return send_large_msg(channel_id, "لآ تہٰلہٰعہٰبہٰ آبہٰنيے 🚷 لآ يہٰمہٰكہٰنہٰك تہٰنہٰزيہٰلہٰ الآدآريے 🤖🍷.") 
      end 
...
local function set_supergroup_photo(msg, success, result) 
  ...
  if success then 
    ...
    save_data(_config.moderation.data, data) 
    send_large_msg(receiver, 'تہٰم 👍 تہٰغہٰيہٰير 🤖 آلہٰصہٰورة ❗️📸', ok_cb, false) 
  else 
...
local function IQ_ABS(msg, matches) 
   ...
   local data = load_data(_config.moderation.data) 
        ...
        local iDev1 = "◥ صہٰدقہٰنہٰيے ✝ تہٰم تہٰفہٰعہٰيل ⁉️ آلہٰمہٰجموعہٰةة  🤖🍷 ◤" 
      ...
      if matches[1] == 'فعل' and is_admin1(msg) and not matches[2] then 
         if not is_super_group(msg) then 
           local iDev1 = "🤖 هہٰذهہٰيے آلہٰمہٰجہٰمہٰوعہٰة مہٰعہٰطہٰلہٰة 📝/n👾 وآنہٰآ سہٰوفہٰ افہٰعہٰلہٰهہٰآ آمہٰراً مہٰن مہٰطہٰوريے 💋🤖" 
           return send_large_msg(receiver, iDev1) 
         end 
...
..'🕵 - آسہٰمہٰكہٰ آلہٰثہٰآنہٰيے 💋😳 : '..(msg.from.lastname or '')..'\n'
...
reply_msg(msg.id, memo, ok_cb, false)
      ...
      if matches[1] == 'تغيير الرابط' and is_momod(msg)then 
         ...
         local receiver = get_receiver(msg) 
            if success == 0 then 
               ...
               send_large_msg(receiver, "تہٰم 👍🏻 تہٰغہٰيہٰير آلہٰرآبہٰط  🤖📌/n آرسہٰلہٰ < الرابط > لہٰمہٰشہٰآهہٰدة آلہٰرآبہٰط آلہٰجہٰديہٰد 👍🤖") 
      ...
      if msg.text then 
         if msg.text:match("^(https://telegram.me/joinchat/%S+)$") and data[tostring(msg.to.id)]['settings']['set_link'] == 'waiting' and is_owner(msg) then 
            ...
            save_data(_config.moderation.data, data) 
            return "تہٰم 👍🏻 حہٰفہٰظ  📝 آلہٰرآبہٰط  💋🙊 آرسہٰلہٰ { الرابط } 👍 لہٰمہٰشہٰآهہٰدةة آلہٰرآبہٰط"
         end 
      end 
      ...
      if matches[1] == 'الرابط' then 
         ...
         return "🔗 رآبہٰط آلہٰمہٰجہٰمہٰوعہٰةة  ["..msg.to.title.."] :\n"..group_link 
      end 
      ...
      if matches[1] == 'مسح' then 
         ...
         if matches[2] == 'الادمنية' then 
            if next(data[tostring(msg.to.id)]['moderators']) == nil then 
               return 'عہٰذراً ❗️لآ يہٰوجہٰد ادمہٰنہٰيہٰة 👥 فہٰيےآلہٰمہٰجہٰمہٰوعہٰة ⁉️ لہٰيہٰتہٰم حہٰذفہٰهہٰم ⚠️'
            end 
            for k,v in pairs(data[tostring(msg.to.id)]['moderators']) do 
            ...
            return 'تہٰم 👍🏻 حہٰذفہ 🤖 قہٰآئہٰمہٰة الآدمہٰنہٰيہٰة 👥 ☑️'
         end 
         if matches[2] == 'القوانين' then 
            local data_cat = 'rules' 
            if data[tostring(msg.to.id)][data_cat] == nil then 
               return "عہٰذراً ❗️لآ يہٰوجہٰد قہٰوآنہٰيہٰن 🚷 فہٰيےآلہٰمہٰجہٰمہٰوعہٰة ⁉️ لہٰيہٰتہٰم حہٰذفہٰهہٰآ ⚠️"
            end 
            data[tostring(msg.to.id)][data_cat] = nil 
            save_data(_config.moderation.data, data) 
            savelog(msg.to.id, name_log.." ["..msg.from.id.."] cleaned rules") 
            return 'تہٰم 👍🏻 حہٰذفہ 🤖 قہٰوآنہٰيہٰن  آلہٰمہٰجہٰمہٰوعہٰة 📊 ☑️'
         end 
         if matches[2] == 'الوصف' then 
            ...
            local data_cat = 'description' 
            if data[tostring(msg.to.id)][data_cat] == nil then 
               return 'عہٰذراً ❗️لآ يہٰوجہٰد وصہٰف 📝 فہٰيےآلہٰمہٰجہٰمہٰوعہٰة ⁉️ لہٰيہٰتہٰم حہٰذفہٰه ⚠️'
            end 
            data[tostring(msg.to.id)][data_cat] = nil 
            save_data(_config.moderation.data, data) 
            savelog(msg.to.id, name_log.." ["..msg.from.id.."] cleaned about") 
            channel_set_about(receiver, about_text, ok_cb, false) 
            return "تہٰم 👍🏻 حہٰذفہ 🤖 وصہٰف آلہٰمہٰجہٰمہٰوعہٰة 📋 ☑️"
         end 
         if matches[2] == 'المكتومين' then 
            chat_id = msg.to.id 
            local hash =  'mute_user:'..chat_id 
               redis:del(hash) 
            return "تہٰم 👍🏻 حہٰذفہ 🤖 قہٰآئہٰمہٰة آلہٰمہٰكہٰتہٰومہٰيہٰن ☑️"
         end 
         if matches[2] == 'المعرف' and is_admin1(msg) then 
            local function ok_username_cb (extra, success, result) 
               local receiver = extra.receiver 
               if success == 1 then 
                  send_large_msg(receiver, "تہٰم 👍🏻 حہٰذفہ 🤖 مہٰعہٰرفہٰ آلہٰمہٰجہٰمہٰوعہٰة ☑️")
               elseif success == 0 then 
                  send_large_msg(receiver, "عہٰذراً ❗️فہٰشہٰل حہٰذفہ مہٰعہٰرفہٰ آلہٰمہٰجہٰمہٰوعہٰة ⁉️⚠️")
               end 
            end 
            local username = "" 
            channel_set_username(receiver, username, ok_username_cb, {receiver=receiver}) 
      ...
      if matches[1] == 'قفل' and is_owner(msg) then 
         ...
         local msg_type = 'Audio' 
            if not is_muted(chat_id, msg_type..': yes') then 
               ...
               return ' 😈تہٰم قہٰفہٰل 🔒آلہٰصہٰوت 🔇✅ \n‼️🤖  ہٰوآسہٰطہٰة :  @'..msg.from.username..'\n🆔 آلآيہٰديے : '..msg.from.id 
            else 
               return ' ✅ تہٰم بآلہٰفہٰعہٰل قہٰفہٰل 🔒آلہٰصہٰوت 🔇 ‼️ \n‼️🤖  ہٰوآسہٰطہٰة :  @'..msg.from.username..'\n🆔 آلآيہٰديے : '..msg.from.id 
            end 
         end 
         ...
         local msg_type = 'Photo' 
            if not is_muted(chat_id, msg_type..': yes') then 
               savelog(msg.to.id, name_log.." ["..msg.from.id.."] set SuperGroup to: mute "..msg_type) 
               mute(chat_id, msg_type) 
               return ' 😈تہٰم قہٰفہٰل 🔒آلہٰصہٰور 📷✅ \n‼️🤖  ہٰوآسہٰطہٰة :  @'..msg.from.username..'\n🆔 آلآيہٰديے : '..msg.from.id 
            else 
               return ' ✅ تہٰم بآلہٰفہٰعہٰل قہٰفہٰل 🔒آلہٰصہٰور 📷 ‼️ \n‼️🤖  ہٰوآسہٰطہٰة :  @'..msg.from.username..'\n🆔 آلآيہٰديے : '..msg.from.id 
            end 
         end 
         ...
         local msg_type = 'Video' 
            if not is_muted(chat_id, msg_type..': yes') then 
               savelog(msg.to.id, name_log.." ["..msg.from.id.."] set SuperGroup to: mute "..msg_type) 
               mute(chat_id, msg_type) 
               return ' 😈تہٰم قہٰفہٰل 🔒آلہٰفہٰيديہٰوهہٰآتہ 📹✅ \n‼️🤖  ہٰوآسہٰطہٰة :  @'..msg.from.username..'\n🆔 آلآيہٰديے : '..msg.from.id 
            else 
               return ' ✅ تہٰم بآلہٰفہٰعہٰل قہٰفہٰل 🔒آلہٰفہٰيديہٰوهہٰآتہ 📹 ‼️ \n‼️🤖  ہٰوآسہٰطہٰة :  @'..msg.from.username..'\n🆔 آلآيہٰديے : '..msg.from.id 
            end 
         end 
         ...
         local msg_type = 'Gifs' 
            if not is_muted(chat_id, msg_type..': yes') then 
               savelog(msg.to.id, name_log.." ["..msg.from.id.."] set SuperGroup to: mute "..msg_type) 
               mute(chat_id, msg_type) 
               return ' 😈تہٰم قہٰفہٰل 🔒آلہٰصہٰور آلہٰمہٰتہٰحہٰركہٰة🌋✅ \n‼️🤖  ہٰوآسہٰطہٰة :  @'..msg.from.username..'\n🆔 آلآيہٰديے : '..msg.from.id 
            else 
               return ' ✅ تہٰم بآلہٰفہٰعہٰل قہٰفہٰل 🔒آلہٰصہٰور آلہٰمہٰتہٰحہٰركہٰة🌋 ‼️ \n‼️🤖  ہٰوآسہٰطہٰة :  @'..msg.from.username..'\n🆔 آلآيہٰديے : '..msg.from.id 
            end 
         end 
         ...
         local msg_type = 'Documents' 
            if not is_muted(chat_id, msg_type..': yes') then 
               savelog(msg.to.id, name_log.." ["..msg.from.id.."] set SuperGroup to: mute "..msg_type) 
               mute(chat_id, msg_type) 
               return ' 😈تہٰم قہٰفہٰل 🔒آلہٰفہٰآيہٰلآتہٰ 🗂✅ \n‼️🤖  ہٰوآسہٰطہٰة :  @'..msg.from.username..'\n🆔 آلآيہٰديے : '..msg.from.id 
            else 
               return ' ✅ تہٰم بآلہٰفہٰعہٰل قہٰفہٰل 🔒آلہٰفہٰآيہٰلآتہٰ 🗂 ‼️ \n‼️🤖  ہٰوآسہٰطہٰة :  @'..msg.from.username..'\n🆔 آلآيہٰديے : '..msg.from.id 
            end 
         end 
         ...
         local msg_type = 'Text' 
            if not is_muted(chat_id, msg_type..': yes') then 
               ...
               return ' ✅ تہٰم بآلہٰفہٰعہٰل قہٰفہٰل 🔒آلہٰدردشہٰه 🇮🇶 ‼️ \n‼️🤖  ہٰوآسہٰطہٰة :  @'..msg.from.username..'\n🆔 آلآيہٰديے : '..msg.from.id 
            end 
         end 
         ...
         local msg_type = 'All' 
            if not is_muted(chat_id, msg_type..': yes') then 
               savelog(msg.to.id, name_log.." ["..msg.from.id.."] set SuperGroup to: mute "..msg_type) 
               mute(chat_id, msg_type) 
               return ' تہٰم 👍🏻قہٰفہٰلہٰ🔒 جہٰمہٰيہٰع آلہٰوسہٰآئہٰط 💉⛔️ \n‼️🤖  ہٰوآسہٰطہٰة :  @'..msg.from.username..'\n🆔 آلآيہٰديے : '..msg.from.id 
            else 
               return ' صہٰدقہٰنہٰيے ✝ تہٰم قہٰفہٰلہٰ🔒 جہٰمہٰيہٰع آلہٰوسہٰآئہٰط 📝📶 \n‼️🤖  ہٰوآسہٰطہٰة :  @'..msg.from.username..'\n🆔 آلآيہٰديے : '..msg.from.id 
            end 
         end 
      end 
      if matches[1] == 'فتح' and is_momod(msg) then 
         ...
         local msg_type = 'Audio' 
            if is_muted(chat_id, msg_type..': yes') then 
               ...
               return ' 👍🏻 تہٰم فہٰتہٰح 🔓آلہٰصہٰوتہٰ🎙☑️ \n‼️🤖  ہٰوآسہٰطہٰة :  @'..msg.from.username..'\n🆔 آلآيہٰديے : '..msg.from.id 
            else 
               return ' ⚠️ تہٰم بآلہٰفہٰعہٰل فہٰتہٰح 🔓آلہٰبصہٰمة (جميع الصوتيات) 🎙⁉️ \n‼️🤖  ہٰوآسہٰطہٰة :  @'..msg.from.username..'\n🆔 آلآيہٰديے : '..msg.from.id 
            end 
         end 
         if matches[2] == 'الصور' then 
         local msg_type = 'Photo' 
            if is_muted(chat_id, msg_type..': yes') then 
               savelog(msg.to.id, name_log.." ["..msg.from.id.."] set SuperGroup to: unmute "..msg_type) 
               unmute(chat_id, msg_type) 
               return ' 👍🏻 تہٰم فہٰتہٰح 🔓آلہٰصہٰور 📸☑️ \n‼️🤖  ہٰوآسہٰطہٰة :  @'..msg.from.username..'\n🆔 آلآيہٰديے : '..msg.from.id 
            else 
               return ' ⚠️ تہٰم بآلہٰفہٰعہٰل فہٰتہٰح 🔓آلہٰصہٰور 📸⁉️ \n‼️🤖  ہٰوآسہٰطہٰة :  @'..msg.from.username..'\n🆔 آلآيہٰديے : '..msg.from.id 
            end 
         end 
         if matches[2] == 'الفيدوهات' then 
         local msg_type = 'Video' 
            if is_muted(chat_id, msg_type..': yes') then 
               savelog(msg.to.id, name_log.." ["..msg.from.id.."] set SuperGroup to: unmute "..msg_type) 
               unmute(chat_id, msg_type) 
               return ' 👍🏻 تہٰم فہٰتہٰح 🔓آلہٰفہٰيديہٰوهہٰآتہ 📽☑️ \n‼️🤖  ہٰوآسہٰطہٰة :  @'..msg.from.username..'\n🆔 آلآيہٰديے : '..msg.from.id 
            else 
               return ' ⚠️ تہٰم بآلہٰفہٰعہٰل فہٰتہٰح 🔓آلہٰفہٰيديہٰوهہٰآتہ 📽⁉️ \n‼️🤖  ہٰوآسہٰطہٰة :  @'..msg.from.username..'\n🆔 آلآيہٰديے : '..msg.from.id 
            end 
         end 
         if matches[2] == 'الصور المتحركه' then 
         local msg_type = 'Gifs' 
            if is_muted(chat_id, msg_type..': yes') then 
               savelog(msg.to.id, name_log.." ["..msg.from.id.."] set SuperGroup to: unmute "..msg_type) 
               unmute(chat_id, msg_type) 
               return ' 👍🏻 تہٰم فہٰتہٰح 🔓آلہٰصہٰور آلہٰمہٰتحہٰركہٰة  🏖☑️ \n‼️🤖  ہٰوآسہٰطہٰة :  @'..msg.from.username..'\n🆔 آلآيہٰديے : '..msg.from.id 
            else 
               return ' ⚠️ تہٰم بآلہٰفہٰعہٰل فہٰتہٰح 🔓آلہٰصہٰور آلہٰمہٰتحہٰركہٰة  🏖 \n‼️🤖  ہٰوآسہٰطہٰة :  @'..msg.from.username..'\n🆔 آلآيہٰديے : '..msg.from.id 
            end 
         end 
         if matches[2] == 'الفايلات' then 
         local msg_type = 'Documents' 
            if is_muted(chat_id, msg_type..': yes') then 
               savelog(msg.to.id, name_log.." ["..msg.from.id.."] set SuperGroup to: unmute "..msg_type) 
               unmute(chat_id, msg_type) 
               return ' 📎🗂تہٰم فہٰتہٰح 🔓آلہٰفہٰآيہٰلآتہٰ 📂 ✔️ \n‼️🤖  ہٰوآسہٰطہٰة :  @'..msg.from.username..'\n🆔 آلآيہٰديے : '..msg.from.id 
            else 
               return ' ⚠️ تہٰم بآلہٰفہٰعہٰل فہٰتہٰح 🔓آلہٰفہٰآيہٰلآتہٰ ☑️ \n‼️🤖  ہٰوآسہٰطہٰة :  @'..msg.from.username..'\n🆔 آلآيہٰديے : '..msg.from.id 
            end 
         end 
         if matches[2] == 'الدردشه' then 
         local msg_type = 'Text' 
            if is_muted(chat_id, msg_type..': yes') then 
               ...
               unmute(chat_id, msg_type) 
               return '❗️☻ ✔️تہٰم فہٰتہٰح آلہٰدردشہٰةة فيے  آلہٰمہٰجموعہٰةة   ✔️ 🇮🇶\n‼️🤖  ہٰوآسہٰطہٰة :  @'..msg.from.username..'\n🆔 آلآيہٰديے : '..msg.from.id 
            else 
         ...
         local msg_type = 'All' 
            if is_muted(chat_id, msg_type..': yes') then 
               savelog(msg.to.id, name_log.." ["..msg.from.id.."] set SuperGroup to: unmute "..msg_type) 
               unmute(chat_id, msg_type) 
               return '❗️☻ تہٰم 👍🏻 فہٰتہٰح 🔓 جہٰمہٰيہٰع آلہٰوسہٰآئہٰط 📙 ✅\n‼️🚸 بہٰوآسہٰطة :    @'..msg.from.username..'\n🆔 آلآيہٰديے : '..msg.from.id 
            else 
               return '❗️☻   صہٰدقہٰنہٰيے ✝ تہٰم فہٰتہٰح 🔓⁉️ جہٰمہٰيہٰع آلہٰوسہٰآئہٰط \n‼️🤖 بہٰوآسہٰطة :    @'..msg.from.username..'\n🆔 آلآيہٰديے : '..msg.from.id 
            end 
         end 
      ...
      if matches[1] == "سكته" or matches[1] == "حجيه" and is_momod(msg) then 
         local chat_id = msg.to.id 
         local hash = "mute_user"..chat_id 
         local user_id = "" 
         if type(msg.reply_id) ~= "nil" then 
         ...
         elseif matches[1] == "حجيه" or matches[1] == "حجيه" and string.match(matches[2], '^%d+$') then 
            local user_id = matches[2] 
            if is_muted_user(chat_id, user_id) then 
               unmute_user(chat_id, user_id) 
               savelog(msg.to.id, name_log.." ["..msg.from.id.."] removed ["..user_id.."] from the muted users list") 
               return "["..user_id.."] ⛔️❗️كہٰبہٰديے 🙊 تہٰم آلہٰغہٰآء آلہٰكہٰتہٰم✔️ يہٰلآ دردشہٰ  " 
            elseif is_momod(msg) then 
               mute_user(chat_id, user_id) 
               savelog(msg.to.id, name_log.." ["..msg.from.id.."] added ["..user_id.."] to the muted users list") 
               return "["..user_id.."]  عہٰمہٰيہٰت ع نہٰفہٰسہٰكہٰ 😷 وحہٰبہٰسہٰوكہٰ بہٰقہٰفہٰص 🙁😹🌚" 
            end 
         elseif matches[1] == "سكته" or matches[1] == "حجيه" and not string.match(matches[2], '^%d+$') then 
            local receiver = get_receiver(msg) 
            local get_cmd = "mute_user" 
            local username = matches[2] 
            local username = string.gsub(matches[2], '@', '') 
